...
test('note task searchable payload contains scout fields', function (): void {
    ...
    expect($task->toSearchableArray())->toBe([
        ...
        'note_path' => 'Daily',
        'note_journal_path_nl' => null,
        'note_journal_path_en' => null,
        'note_type' => null,
        'note_journal_granularity' => null,
        'note_icon' => null,
        'note_icon_color' => null,
        'note_icon_bg' => null,
        'workspace_id' => 'workspace-1',
        'note_id' => 'note-1',
        'parent_note_id' => 'parent-note-1',
        'checked' => false,
        'task_status' => 'backlog',
        'search_status' => 'backlog',
        'search_status_rank' => 70,
        'due_date' => '2026-03-20',
        'deadline_date' => '2026-03-21',
        'journal_date' => '2026-03-19',
    ]);
