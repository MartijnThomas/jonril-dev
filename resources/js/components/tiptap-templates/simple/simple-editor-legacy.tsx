...
import { createLegacyEditorExtensions } from '@/components/tiptap-templates/simple/legacy-editor-extensions';
import type {
    SimpleEditorContent,
    SimpleEditorProps,
...
function SimpleEditorLegacyComponent({
    id = '',
    noteUpdateUrl = '',
    content = '',
    properties = {},
...
export const SimpleEditorLegacy = memo(SimpleEditorLegacyComponent);
