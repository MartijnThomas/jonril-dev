  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "h-(--cell-size) w-(--cell-size) text-center align-middle text-sm font-light text-muted-foreground select-none",
          defaultClassNames.weekday
        ),
        week: cn("mt-1 w-full", defaultClassNames.week),
        week_number_header: cn(
          "h-(--cell-size) w-(--cell-size) text-center align-middle text-sm font-normal text-muted-foreground select-none",
        ...
        day: cn(
          "group/day relative h-(--cell-size) w-(--cell-size) p-0 text-center text-sm align-middle select-none [&:last-child[data-selected=true]_button]:rounded-r-md",
